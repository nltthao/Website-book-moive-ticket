...
import { UserOutlined, SnippetsOutlined, FileAddOutlined,DashboardOutlined} from '@ant-design/icons';
        ...
        <>
            ...
            <div className='hidden xl:block'>
                <Layout className='min-h-screen'>
                    <Sider trigger={null} collapsible  className=''>
                            ...
                            items={[
                                ...
                                },
                                {
                                    ...
                                    children: [{
                                        key: '11',
                                        icon: <SnippetsOutlined />,
                                        label: <NavLink to='schedule'>Quản lý suất chiếu</NavLink>,
                                    },
                                    {
                                        key: '12',
                                        icon: <FileAddOutlined />,
                                        label: <NavLink to='schedule/addnewschedule'>Add User</NavLink>,
                                    },
                                    ]
                                },
                                
                                {
                                    ...
                                    children: [{
                                        key: '11',
                                        icon: <SnippetsOutlined />,
                                        label: <NavLink to='cinema'>Quản lý cụm rạp</NavLink>,
                                    },
                                    {
                                        key: '12',
                                        icon: <FileAddOutlined />,
                                        label: <NavLink to='cinema/addnewscinema'>Thêm rạp</NavLink>,
                                    },
                                    ]
                                },
