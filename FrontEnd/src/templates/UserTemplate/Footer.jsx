...
export default function Footer() {
    return (
        <footer className="px-4 divide-y bg-neutral-900 text-gray-100">
                ...
                <div className="grid grid-cols-1 text-sm gap-x-3 gap-y-8 lg:w-3/4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-3">
                            <li>
                                <a href="https://www.facebook.com/profile.php?id=100011911592846" target='_blank' className='text-zinc-300 title-widget-item'><FontAwesomeIcon className='w-8 h-8 md:w-11 md:h-11 mr-3' icon={faSquareFacebook} /></a>
            ...
            <div className="py-6 text-sm text-center text-gray-400">© 2024 Nguyễn Lê Thu Thảo</div>
        </footer>
    )
}
